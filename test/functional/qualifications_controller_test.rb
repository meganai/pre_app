...
class QualificationsControllerTest < ActionController::TestCase
  ...
  test "should create qualification" do
    assert_difference('Qualification.count') do
      post :create, qualification: { details: @qualification.details, grade: @qualification.grade, name: @qualification.name }
    end
  ...
  test "should update qualification" do
    put :update, id: @qualification, qualification: { details: @qualification.details, grade: @qualification.grade, name: @qualification.name }
    assert_redirected_to qualification_path(assigns(:qualification))
  end
